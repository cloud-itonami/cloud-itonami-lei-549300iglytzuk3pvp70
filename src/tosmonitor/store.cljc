(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (WEC Energy Group, Inc., LEI
  549300IGLYTZUK3PVP70) -- unlike `commitledger.store`'s multi-application
...
(defn demo-company []
  {:legal-name "WEC Energy Group, Inc."
   :website    "https://www.wecenergygroup.com"})

(def ^:private demo-full-text
  "Terms of Use\nThese Terms of Use apply to your access to and use of the WEC Energy Group, Inc. website. By using this site you agree to these Terms, which may change without notice. This agreement is governed by the laws of the State of Wisconsin.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.wecenergygroup.com/home/terms.htm"
