...
This repository archives the publicly published Terms of Use of WEC
Energy Group, Inc., per ADR-2607110300 -- a read-only reference archive.
As part of a 10-repo validation batch extending the
...
- **Company**: WEC Energy Group, Inc., LEI 549300IGLYTZUK3PVP70, website
  `https://www.wecenergygroup.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url
  `https://www.wecenergygroup.com/home/terms.htm`, retrieved-at
